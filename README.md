...
# What does it do?
This pipeline extracts historical PV data (the amount of energy generated by solar panel systems in the past) from an S3 bucket. It then processes the data and loads it into BigQuery for data analysis. The data is also stored locally (on my PC) to be used for training models.
